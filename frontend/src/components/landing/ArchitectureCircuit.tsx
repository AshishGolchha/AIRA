...
export const ArchitectureCircuit: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto rounded-3xl bg-surface-200/90 border border-border-strong p-6 sm:p-8 lg:p-10 backdrop-blur-xl relative overflow-hidden font-sans text-left">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 relative z-10 mb-8 items-stretch">
        ...
        {/* ========================================================= */}
        <div className="lg:col-span-4 flex flex-col justify-between p-5 rounded-2xl bg-surface-100/70 border border-brand-500/30 space-y-4">
          <div>
            <div className="flex items-center justify-between pb-3 mb-3 border-b border-border-subtle">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-brand-500/20 flex items-center justify-center text-brand-cyan">
            ...
            <div className="space-y-2.5">
              <button
                ...
                className={`w-full text-left p-3 rounded-xl border transition-all text-xs ${
                  selectedModuleId === 'ai-synthesis'
                    ...
                    : 'bg-surface-200/50 border-border-subtle text-slate-300 hover:bg-surface-200'
                }`}
              >
                ...
                <span className="text-[11px] text-slate-400 block">CrewAI consensus across 3 analytical roles.</span>
              </button>
              ...
              >
                ...
                <span className="text-[11px] text-slate-400 block">Citations extracted from SEC 10-K & 10-Q filings.</span>
              </button>
            </div>
          </div>

          <div className="pt-3 border-t border-border-subtle text-[11px] font-mono text-brand-cyan flex items-center gap-1.5">
        ...
        {/* ========================================================= */}
        <div className="lg:col-span-4 flex flex-col justify-between p-5 rounded-2xl bg-surface-100/70 border border-brand-emerald/30 space-y-4">
          <div>
            <div className="flex items-center justify-between pb-3 mb-3 border-b border-border-subtle">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-brand-emerald/20 flex items-center justify-center text-brand-emerald">
            ...
            <div className="space-y-2.5">
              ...
              >
                <div className="flex items-center justify-between font-semibold mb-1">
                  ...
                  <PieChart className="w-3 h-3 text-brand-emerald" />
                </div>
                <span className="text-[11px] text-slate-400 block">Exact FIFO cost basis and asset weighting.</span>
              </button>
              ...
              >
                <div className="flex items-center justify-between font-semibold mb-1">
                  ...
                  <Bell className="w-3 h-3 text-brand-emerald" />
                </div>
                <span className="text-[11px] text-slate-400 block">Signed webhooks & price swing triggers.</span>
              </button>
            </div>
          </div>

          <div className="pt-3 border-t border-border-subtle text-[11px] font-mono text-brand-emerald flex items-center gap-1.5">
        ...
        {/* ========================================================= */}
        <div className="lg:col-span-4 flex flex-col justify-between p-5 rounded-2xl bg-gradient-to-b from-surface-100 to-surface-300 border border-brand-300/40 shadow-glow-brand space-y-4">
          <div>
            <div className="flex items-center justify-between pb-3 mb-3 border-b border-border-subtle">
              <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-mono text-brand-300 bg-brand-500/20 px-2 py-0.5 rounded border border-brand-300/30">
                OUTPUT
              </span>
            </div>
            ...
            <button
              ...
              className={`w-full text-left p-3.5 rounded-xl border transition-all text-xs ${
                selectedModuleId === 'convergence'
                  ? 'bg-brand-500/25 border-brand-300 text-white shadow-glow-brand'
                  : 'bg-surface-200/60 border-border-subtle text-slate-300 hover:bg-surface-200'
              }`}
            >
          ...
          <div className="p-3 rounded-xl bg-surface-400/80 border border-border-subtle text-[11px] font-mono text-slate-300 flex items-center justify-between">
            <span>Formula:</span>
            <strong className="text-white">AI Reason + Math Truth</strong>
          </div>
        </div>
      </div>

      {/* Selected Module Deep-Dive Inspector */}
      <div className="p-5 rounded-2xl bg-surface-300/90 border border-border-subtle text-xs relative z-10">
        <div className="flex flex-wrap items-center justify-between gap-2 pb-3 mb-3 border-b border-border-subtle">
          <div className="flex items-center gap-2">
            <span className="text-xs font-bold text-white font-sans">{active.title}</span>
            <span className="text-[10px] font-mono text-brand-cyan bg-brand-cyan/10 px-2 py-0.5 rounded">
              {active.tag}
            </span>
          </div>
          <span className="text-[11px] text-brand-emerald font-semibold flex items-center gap-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2 text-[11px] font-sans text-slate-300">
          {active.rules.map((rule, idx) => (
            <div key={idx} className="p-2 rounded-lg bg-surface-200/60 border border-border-subtle flex items-start gap-2">
