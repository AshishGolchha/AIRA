...
const SCENARIOS: Record<string, TickerScenario> = {
  NVDA: {
    ...
    pe: '64.2x',
    evEbitda: '51.8x',
    marketCap: '₹274.9T (₹275L Cr)',
    activeSignals: [
      'SEC 10-Q: Data Center revenue reached ₹2,28,810 Cr ($26.3B, +154% YoY)',
    ...
    synthesis: {
      ...
      deterministicRule: 'Price Alert: Trigger if 24h delta exceeds ±5.0% (₹10,620.50 / ₹11,738.50).',
    },
  },
  AAPL: {
    ticker: 'AAPL',
    ...
    pe: '33.1x',
    evEbitda: '24.6x',
    marketCap: '₹297.5T (₹298L Cr)',
    activeSignals: [
      'Services segment revenue hit all-time record ₹2,10,540 Cr ($24.2B) with 74% gross margin',
    ...
    agents: [
      ...
      },
      {
        ...
        sentiment: 'neutral',
        quote: 'P/E multiple expanded from 25x to 33x. Aggressive annual capital return provides valuation floor.',
      },
      {
        role: 'Macro Risk Officer',
        focus: 'Regulatory & Hardware Cycle',
        sentiment: 'cautious',
        quote: 'Antitrust inquiry into App Store revenue share creates potential 5-8% EBITDA margin headwind.',
      },
    ],
    synthesis: {
      ...
      deterministicRule: 'Drawdown Alert: Trigger if position dips below 200-day moving avg (₹18,139.50).',
    },
  },
  MSFT: {
    ticker: 'MSFT',
    ...
    activeSignals: [
      ...
      'Quarterly capital expenditures reached ₹1,65,300 Cr dedicated to AI data centers',
    ],
    agents: [
      {
        role: 'Fundamental Analyst',
      ...
      },
      {
        ...
        sentiment: 'cautious',
        quote: 'Elevated quarterly capex creates near-term free cash flow margin compression.',
      },
      {
        role: 'Macro Risk Officer',
    ...
    synthesis: {
      ...
      deterministicRule: 'Price Alert: Trigger if 24h delta exceeds ±4.5% (₹34,729.50 / ₹38,002.50).',
    },
  },
};
