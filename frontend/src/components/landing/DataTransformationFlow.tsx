  ...
  return (
    <div className="w-full max-w-5xl mx-auto rounded-3xl bg-surface-200/90 border border-border-strong p-6 sm:p-8 backdrop-blur-xl font-sans text-left relative overflow-hidden shadow-2xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-stretch relative z-10 mb-6">
        ...
        {/* ========================================================================= */}
        <div className="lg:col-span-4 p-4 rounded-2xl bg-surface-100/80 border border-border-subtle flex flex-col justify-between space-y-3">
          <div>
            <div className="flex items-center justify-between pb-2 mb-3 border-b border-border-subtle">
              <span className="text-xs font-bold uppercase tracking-wider text-slate-300">
                1. Raw Signals
              </span>
              <span className="text-[10px] font-mono text-slate-400">UNSTRUCTURED</span>
            </div>
                  ...
                  <button
                    ...
                    className={`w-full text-left p-2.5 rounded-xl border transition-all text-xs ${
                      isSelected
                        ...
                        : 'bg-surface-200/50 border-border-subtle text-slate-400 hover:text-slate-200'
                    }`}
                  >
                    <div className="font-semibold text-white truncate">{sig.type}</div>
                    <div className="text-[10px] text-slate-400 font-mono truncate">{sig.source}</div>
                  </button>
                );
              })}
            </div>
          ...
          <div className="p-2.5 rounded-xl bg-surface-300/80 border border-border-subtle text-[11px] font-mono text-slate-400 italic">
        ...
        {/* ========================================================================= */}
        <div className="lg:col-span-4 p-5 rounded-2xl bg-gradient-to-b from-surface-100 to-surface-300 border border-brand-500/40 shadow-glow-brand flex flex-col justify-between space-y-4">
          <div>
            <div className="flex items-center justify-between pb-2 mb-3 border-b border-border-subtle">
            ...
            <div className="space-y-2 text-xs">
              <div className="p-2 rounded-xl bg-surface-200/70 border border-border-subtle flex items-center justify-between">
                <span className="text-slate-300">Semantic Parsing</span>
                <span className="font-mono text-[10px] text-brand-cyan">pgvector</span>
              </div>
              <div className="p-2 rounded-xl bg-surface-200/70 border border-border-subtle flex items-center justify-between">
                <span className="text-slate-300">Multi-Agent Debate</span>
                <span className="font-mono text-[10px] text-brand-300">CrewAI</span>
              </div>
              <div className="p-2 rounded-xl bg-surface-200/70 border border-border-subtle flex items-center justify-between">
                <span className="text-slate-300">Deterministic Math</span>
                <span className="font-mono text-[10px] text-brand-emerald">SQL Certainty</span>
              </div>
            </div>
          </div>

          <div className="p-2.5 rounded-xl bg-brand-500/10 border border-brand-500/30 text-center text-[11px] font-mono text-brand-cyan font-bold">
        ...
        {/* ========================================================================= */}
        <div className="lg:col-span-4 p-4 rounded-2xl bg-surface-100/80 border border-brand-emerald/40 flex flex-col justify-between space-y-3">
          <div>
            <div className="flex items-center justify-between pb-2 mb-3 border-b border-border-subtle">
              <span className="text-xs font-bold uppercase tracking-wider text-brand-emerald">
                3. Actionable Output
              </span>
              <span className="text-[10px] font-mono text-brand-emerald bg-brand-emerald/10 px-2 py-0.5 rounded">
                GROUNDED
              </span>
            </div>

            <div className="p-3 rounded-xl bg-surface-200/90 border border-border-subtle text-xs text-white leading-relaxed">
              <CheckCircle2 className="w-4 h-4 text-brand-emerald inline mr-1.5 shrink-0" />
              {activeSignal.transformedOutput}
            </div>
          </div>

          <div className="p-2.5 rounded-xl bg-brand-emerald/10 border border-brand-emerald/20 text-[11px] font-mono text-brand-emerald flex items-center justify-between">
