...
const MARKET_DATA: Record<string, TickerData> = {
  NVDA: {
    ...
    currentPrice: '₹11,179.50',
    change: '+142.8% (1Y)',
    isPositive: true,
    peRatio: '64.2x',
    evEbitda: '51.8x',
    fcfYield: '2.8%',
    range52w: { low: 3932.4, high: 12240.9, current: 11179.5 },
    points: [
      { date: 'Oct 25', price: 4176.0 },
      { date: 'Nov 25', price: 4741.5 },
      {
        date: 'Dec 25',
        price: 5916.0,
        label: 'SEC 10-Q Ingested',
        signalType: 'ingestion',
        signalDetail: 'Data Center revenue surged +154% YoY to ₹2,28,810 Cr ($26.3B).',
      },
      { date: 'Jan 26', price: 6890.4 },
      { date: 'Feb 26', price: 8038.8 },
      {
        date: 'Mar 26',
        price: 9570.0,
      ...
      { date: 'Jun 26', price: 11179.5 },
    ],
  },
  AAPL: {
    symbol: 'AAPL',
    companyName: 'Apple Inc',
    currentPrice: '₹19,505.40',
    change: '+24.5% (1Y)',
    isPositive: true,
    peRatio: '33.1x',
    evEbitda: '24.6x',
    fcfYield: '3.4%',
    range52w: { low: 14268.0, high: 20636.4, current: 19505.4 },
    points: [
      { date: 'Oct 25', price: 14964.0 },
      { date: 'Nov 25', price: 15703.5 },
      {
        date: 'Dec 25',
        price: 16965.0,
      ...
      { date: 'Jan 26', price: 16356.0 },
      { date: 'Feb 26', price: 17574.0 },
      {
        date: 'Mar 26',
        price: 18705.0,
      ...
      { date: 'Jun 26', price: 19505.4 },
    ],
  },
  MSFT: {
    symbol: 'MSFT',
    companyName: 'Microsoft Corp',
    currentPrice: '₹39,054.30',
    change: '+31.2% (1Y)',
    isPositive: true,
    peRatio: '36.8x',
    evEbitda: '25.9x',
    fcfYield: '2.5%',
    range52w: { low: 29580.0, high: 40742.1, current: 39054.3 },
    points: [
      { date: 'Oct 25', price: 30276.0 },
      { date: 'Nov 25', price: 31755.0 },
      {
        date: 'Dec 25',
        price: 33756.0,
      ...
      { date: 'Jan 26', price: 34974.0 },
      { date: 'Feb 26', price: 36540.0 },
      {
        date: 'Mar 26',
        price: 37845.0,
      ...
      { date: 'Apr 26', price: 36975.0 },
      {
        date: 'May 26',
        price: 38280.0,
        label: 'Earnings Verified',
        signalType: 'alert',
        signalDetail: 'Quarterly EPS beat verified against SEC 10-Q filing.',
      },
      { date: 'Jun 26', price: 39054.3 },
    ],
  },
};
