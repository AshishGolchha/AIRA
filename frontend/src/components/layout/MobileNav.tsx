...
export const MobileNav: React.FC<MobileNavProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 lg:hidden">
      ...
      {/* Drawer */}
      <div className="fixed inset-y-0 left-0 w-72 bg-surface-50 dark:bg-surface-300 border-r border-border-strong p-5 flex flex-col justify-between z-10 shadow-2xl animate-in slide-in-from-left duration-200">
        <div>
          {/* Header */}
          <div className="flex items-center justify-between pb-4 border-b border-border-subtle">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={onClose}
                className="text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white p-1.5 rounded-lg hover:bg-slate-900/5 dark:hover:bg-white/5"
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    cn(
                      ...
                      isActive
                        ? 'bg-brand-600 text-white shadow-md border border-brand-500/30 font-semibold'
        ...
        <div className="pt-4 border-t border-border-subtle">
          <div className="flex items-center justify-between p-2 rounded-xl bg-surface-100 dark:bg-surface-200/50 border border-border-subtle mb-2">
            ...
            <button
              ...
              className="text-slate-500 dark:text-slate-400 hover:text-rose-600 dark:hover:text-rose-400 p-1.5 rounded-lg hover:bg-rose-500/10"
              title="Sign Out"
            >
