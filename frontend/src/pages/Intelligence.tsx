            ...
            <div className="space-y-6">
              ...
              <GlassCard glow="brand" className="p-6">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="text-xs uppercase tracking-wider font-semibold text-slate-400 mb-1.5">
                      Executive Summary
                    </h4>
                ...
                <GlassCard className="p-5">
                  ...
                  <ul className="space-y-2 text-xs text-slate-300">
                    {activeReport.watchlist_priorities.map((item, idx) => (
                      <li key={idx} className="flex items-start gap-2 bg-surface-100 p-2.5 rounded-lg border border-border-subtle">
                ...
                <GlassCard className="p-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2">
                    {activeReport.sources.map((src, idx) => (
                      <div
                        key={idx}
                        className="p-2.5 rounded-lg bg-surface-300/60 border border-border-subtle text-[11px] font-mono text-slate-400"
                      >
